...
class _PasswordStrengthState extends State<PasswordStrength>
  ...
  updateCursorPosition({rerender = false}) {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      var transX = min(
        inputCloneBox.size.width - 3,
        inputBox.constraints.maxWidth - 24,
      );
  ...
  getErrText(String title, bool valid) {
    var color =
        _passFocusNode.hasFocus || _inputController.text.isEmpty
            ? Colors.grey
            : valid
            ? Colors.blueAccent
            : Colors.red;
  ...
  void initState() {
    ...
    _inputController.addListener(() {
      ...
      _passCloneController.value = TextEditingValue(
        text: _inputController.text.substring(
          0,
              ...
              text: TextSpan(
                ...
                children: [
                  ...
                  getErrText(
                    ...
                    _passwordValidity.specialChar,
                  ),
                  const TextSpan(text: " and be at least "),
                  getErrText(
                    "${widget.maxLength} characters long",
